...
class User(db.Model):
    ...
    def registered_on_str(self):
        """
        The @hybrid_property decorator is another SQLAlchemy feature
        This decorator is used to create "computed" or "virtual" columns
        whose value is computed from the values of one or more columns.
        In this instance, the registered_on_str column converts the datetime value
        stored in registered_on to a formatted string.
        """
