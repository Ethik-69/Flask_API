...
class RegisterUser(Resource):
    ...
    # The expect decorator is used to specify the data that the server expects
    # the client to send in the HTTP request.
    # The response decorator is solely for documentation purposes.
    # The function docstring will be rendered on the Swagger UI page.
...
class GetUser(Resource):
    ...
    def get(self):
        ...
        # https://aaronluna.dev/series/flask-api-tutorial/part-4/#getuser-resource
